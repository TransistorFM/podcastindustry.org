...
The current estimate for global podcast industry annual revenue is approximately $4.1 - $4.8 billion. This estimate is based on available data from various segments of the podcast industry, including advertising, hosting, equipment, and direct listener support. However, this estimate is likely conservative as we still need to gather data and make estimates for several other categories.
...
Rationale: We need to estimate the value of revenue derived from companies like Riverside, Squadcast, Zencastr who offer podcast recording software as well as editing. There are other editing tools like Descript, GarageBand, Audacity, Adobe Audition, Logic Pro that podcasters use to edit episodes.
...
Rationale: We need to research companies providing podcast production services, including editing, sound design, and post-production. This category may include both large production houses and freelance services.
...
Rationale: We should research software tools used by podcasters: roviding analytics and measurement services, DAWs, transcription services, etc
...
2. Varying definitions of what constitutes podcast-related revenue
3. Potential overlap between categories (e.g., some hosting providers also offer advertising services)
